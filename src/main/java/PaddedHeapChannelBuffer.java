 ...
 */
public abstract class PaddedHeapChannelBuffer extends PaddedAbstractChannelBuffer {
     ...
     */
    protected PaddedHeapChannelBuffer(int length) {
     ...
     */
    protected PaddedHeapChannelBuffer(byte[] array) {
     ...
     */
    protected PaddedHeapChannelBuffer(byte[] array, int readerIndex, int writerIndex) {
        if (array == null) {
    ...
    public void getBytes(int index, ChannelBuffer dst, int dstIndex, int length) {
        if (dst instanceof PaddedHeapChannelBuffer) {
            getBytes(index, ((PaddedHeapChannelBuffer) dst).array, dstIndex, length);
        } else {
    ...
    public void setBytes(int index, ChannelBuffer src, int srcIndex, int length) {
        if (src instanceof PaddedHeapChannelBuffer) {
            setBytes(index, ((PaddedHeapChannelBuffer) src).array, srcIndex, length);
        } else {
