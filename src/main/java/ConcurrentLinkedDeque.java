...
import jsr166.concurrent.ReflectedUnsafe;
...
public class ConcurrentLinkedDeque<E>
  ...
  private volatile long u0, u1, u2, u3, u4, u5, u6, u7;
  private transient volatile Node<E> tail;
  private volatile long v0, v1, v2, v3, v4, v5, v6, v7;
  private volatile long x0, x1, x2, x3, x4, x5, x6, x7;
  ...
  static final class Node<E> {
    ...
    static {
      try {
        UNSAFE = ReflectedUnsafe.getUnsafe();
        Class k = Node.class;
