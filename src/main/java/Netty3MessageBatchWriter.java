...
public class Netty3MessageBatchWriter {
   ...
   */
  public Netty3MessageBatchWriter(final NioSocketChannel channel) {
  ...
  public void write(final Message message) {
    ...
    final int frameSize = message.serializedSize() + HEADER_SIZE;
  ...
  public void flush() {
    ...
    for (int i = 0; i < queue.size(); i++) {
      final Message message = queue.get(i);
      final int size = message.serializedSize();
